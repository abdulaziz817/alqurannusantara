    ...
    <>
      ...
      <div className="fixed bottom-6 right-5 flex flex-col gap-3 z-50">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="group relative p-3 rounded-2xl bg-white/10 backdrop-blur-md shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 text-white"
        >
          <MdArrowBack size={22} />
        ...
        {homeButton && (
          ...
          >
            <Link
              href="/home"
              className="p-3 rounded-2xl bg-white/10 backdrop-blur-md shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 text-white flex items-center justify-center"
            >
              <MdHome size={22} />
            </Link>
            <span className="absolute right-14 top-1/2 -translate-y-1/2 bg-gray-900/90 text-white text-xs px-2 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
